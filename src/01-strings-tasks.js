...
function extractNameFromTemplate(value) {
  const newString = value.split(',')[1].trim();
...
function encodeToRot13(str) {
  const alfabet = 'abcdefghijklmnopqrstuvwxyzabcdefghijklmABCDEFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLM';
  // const rot13alfabet = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
  return str.replace(
    /[A-Za-z]/gi,
    (letter) => alfabet[alfabet.indexOf(letter) + 13],
  );
}
